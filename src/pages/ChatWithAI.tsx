 ...
 * Real implementation using Convex and OpenAI
 *
 * Features:
 * - Real AI responses with RAG context
...
const ChatWithAI: React.FC<ChatWithAIProps> = ({ userId, conversationId }) => {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <div className={`h-2 w-2 rounded-full ${activeConversationId ? 'bg-green-500' : 'bg-yellow-500'} animate-pulse`}></div>
                  <span className="text-xs sm:text-sm text-muted-foreground">
                    {activeConversationId ? 'Online' : 'Connecting...'}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="container-padding py-3 sm:py-4">
          <div className="flex gap-2 sm:gap-3">
            ...
            <Button
              ...
              size="icon"
              onClick={handleSend}
              disabled={!inputValue.trim() || isLoading || !activeConversationId}
